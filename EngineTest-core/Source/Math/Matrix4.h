...
namespace EngineTest { namespace Math {
	...
	struct Matrix4
	{
		...
		static Matrix4 Simple2DTransform(const Vector3& position, const Vector2& scale, float radians);
		static void Simple2DTransform(Matrix4& matrix, const Vector3& position, const Vector2& scale, float radians);
